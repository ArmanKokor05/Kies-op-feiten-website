...
<template>
  <div class="list-inner">
    <div class="list-header">
      <p class="list-label">Jouw reactie op:</p>
      <h3 class="list-title">{{ response.discussion_title }}</h3>
    </div>

    <div class="list-content">
      <p>{{ cutContent(response.content, 20) }}</p>
    </div>

    <div class="list-footer">
      <span class="list-date">Gereageerd op: {{ formatDate(response.created_at) }}</span>
